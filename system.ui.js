var systemUI = {
    run: function() {
        ...
        Game.spawns['French Armada From Spain'].room.visual.text('Total Energy: ' + totalEnergy, Game.spawns['French Armada From Spain'].pos.x + 6, Game.spawns['French Armada From Spain'].pos.y + 4, {align: 'left', opacity: 0.8});
