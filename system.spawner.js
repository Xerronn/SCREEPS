var systemSpawner2 = {
    run: function() {
        ...
        const TASK_LIST_UPGRADER = [TASK_WITHDRAW_STORAGE, TASK_PILLAGE, TASK_WITHDRAW_CONTAINER, TASK_HARVEST_ENERGY, TASK_UPGRADE, TASK_UPGRADE_LINK];
        ...
        for (let room of myRooms) {
            ...
            let numTransporter = Memory.roomsPersistent[room].creepCounts["transporter"];
            if (numTransporter < roomContainers.length) {
